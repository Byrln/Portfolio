...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary: "Аяллын компаниудын аялал, гаралт, захиалга, төлбөр, харилцагчийн мэдээллийг нэг ажлын урсгалд төвлөрүүлэх бүтээгдэхүүн.",
    url: "#contact",
    image: "/projects/toms.png",
    alt: "TOMS аяллын технологийн бүтээгдэхүүн",
    context: "Аяллын компаниудын өдөр тутмын олон ажлыг нэг дороос удирдах бүтээгдэхүүний суурь бүтэц хэрэгтэй байсан.",
    contribution: "Бүтээгдэхүүний UX, ажлын урсгал, интерфэйсийн компонентууд.",
    approach: ["Аялал, гаралт, захиалгыг нэг ажлын урсгалд холбосон", "Давтагддаг мэдээллийг дахин ашиглах бүтэц байгуулсан", "Өдөр тутмын хэрэглээнд тохирсон энгийн дэлгэцүүд төлөвлөсөн"],
